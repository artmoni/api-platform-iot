 ...
 */
final class Version20200117094225 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE heater (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE opening (id INT NOT NULL, PRIMARY KEY(id))');
